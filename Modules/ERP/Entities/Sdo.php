...
class Sdo extends Model
{
    ...
    public function fetch_sdo_export_data(){
        
        $data = Sdo::with('province:province_name,id',
        'zone:zone_name,id','division:division_name,id','district:district_name,id',
        'tehsil:tehsil_name,id','chiefEngineer:name,id','suprEngineer:name,id','exeEngineer:name,id')->get();
