...
Route::group(
    ...
    function () {
        ...
        Route::get('get-provinces-list', 'CommonController@get_provinces_list');
        ...
        */
        ...
        Route::get('get-zones-list', 'CommonController@get_zones_list')->name('get-zones-list');
        ...
        // Data table listing
        Route::get('get-divisions-list', 'CommonController@get_division_list_dt')->name('get-divisions-list');
        ...
        // Data table listing 
        // Route::get('get-districts-list', 'CommonController@get_district_list_dt')->name('get-districts-list');
        Route::get('get-districts-list', 'CommonController@get_district_list')->name('get-districts-list');
        ...
        Route::get('check-total-pp-against-na', 'CommonController@check_total_pp_against_na')->name('check-total-pp-against-na');
        ...
        Route::get('get-ce-list-by-zone/{zone_id}', 'CommonController@get_ce_list')->name('get-ce-list-by-zone');
        ...
        Route::get('get-se-list-by-division/{division_id}', 'CommonController@get_se_list')->name('get-se-list-by-division');
        ...
        Route::get('get-ee-list-by-district/{district_id}', 'CommonController@get_ee_list')->name('get-ee-list-by-district');
        ...
        Route::get('get-sdo-list-by-tehsil/{tehsil_id}', 'CommonController@get_sdo_list')->name('get-sdo-list-by-tehsil');
        ...
        Route::get('get-sub-head-list-by-main/{main_id}', 'CommonController@get_sub_head_list')->name('get-sub-head-list-by-main');
        ...
        // Export/Download Data APIs
        // Route::get('download-province-data', 'CommonController@download_province_data')->name('download-province-data');
        
        
    }
);
Route::group(
    ['middleware' => 'guest', 'namespace' => 'CsvActions'],
    function () {
        ...
        // Location Codes
        Route::get('download-province-data', 'ProvinceCsvExportController');
        Route::get('download-zone-data',     'ZoneCsvExportController');
        Route::get('download-division-data', 'DivisionCsvExportController');
        Route::get('download-district-data', 'DistrictCsvExportController');
        Route::get('download-tehsil-data', 'TehsilCsvExportController');
        Route::get('download-union-data', 'UnionCsvExportController');
        
        // Constituency 
        Route::get('download-na-data', 'NACsvExportController');
        Route::get('download-pp-data', 'PPCsvExportController');
        
        // Executing Office
        Route::get('download-ce-data', 'CECsvExportController');
        Route::get('download-se-data', 'SECsvExportController');
        Route::get('download-ee-data', 'EECsvExportController');
        Route::get('download-sdo-data', 'SDOCsvExportController');
        Route::get('download-sub-data', 'SubCsvExportController');
        
        // Period Codes
        Route::get('download-year-data', 'YearCsvExportController');
        Route::get('download-month-data', 'MonthCsvExportController');
        
        // Status Codes
        Route::get('download-approved-data', 'ApprovalCsvExportController');
        Route::get('download-funding-data', 'FundingCsvExportController');
        Route::get('download-completion-data', 'CompletionCsvExportController');
        Route::get('download-functional-data', 'FunctionalCsvExportController');
        
        // Infrastructure Codes
        Route::get('download-infra-data', 'InfraCsvExportController');
        Route::get('download-shead-data', 'SHeadCsvExportController');
        Route::get('download-dhead-data', 'DHeadCsvExportController');
        Route::get('download-material-data', 'MaterialCsvExportController');
        
        // General Codes
        Route::get('download-unit-data', 'UnitCsvExportController');
        Route::get('download-sagency-data', 'SponsCsvExportController');
        Route::get('download-eagency-data', 'EAgencyCsvExportController');
        Route::get('download-wquality-data', 'WQualityCsvExportController');
        Route::get('download-ttype-data', 'TTypeCsvExportController');
        Route::get('download-snature-data', 'SNatureCsvExportController');
        Route::get('download-om-data', 'OMCsvExportController');
        Route::get('download-wsource-data', 'WSourceCsvExportController');
        Route::get('download-area-data', 'AreaCsvExportController');
        Route::get('download-stype-data', 'STypeCsvExportController');
    }
);
