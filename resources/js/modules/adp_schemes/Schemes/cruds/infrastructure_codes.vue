                  ...
                  <tbody>
                    <template v-if="ListOfSubHead">
                        <tr v-for="(item, index) in ListOfSubHead" :key="index">
                          <td>{{ ++index }}</td>
                          <td>{{ item.main_head ? item.main_head.infra_desc : 'N/A' }}</td>
                          <!-- <td>{{ item.id ? item.id : 'N/A' }}</td> -->
                  ...
                  <tbody>
                    <template v-if="ListOfDetailHead">
                        <tr v-for="(item, index) in ListOfDetailHead" :key="index">
                          <td>{{ ++index }}</td>
                          <td>{{ item.main_head ? item.main_head.infra_desc : 'N/A' }}</td>
                          <td>{{ item.sub_head ? item.sub_head.sub_head_desc : 'N/A' }}</td>
                        ...
                        <div class="form-card">
                          <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                              <label>Infrastructure Code</label>
                              <select2
                                v-model="formFieldsDetailHeadModal.infra_idFk"
                                placeholder="Select Infrastructure Code"
                                :options="DropdownMainHead"
...
export default {
  ...
  methods: {
    ...
    mainHeadChanged(id){
      axios.get("get-sub-head-list-by-main/"+id).then((response) => {
